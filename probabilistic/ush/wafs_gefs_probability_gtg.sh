...
fieldlist="FL240EDPARM FL270EDPARM FL300EDPARM FL340EDPARM FL390EDPARM FL450EDPARM"
...
if [ "$IFGEFS" = "YES" ]; then
  ...
  for cfield in $fieldlist; do
    ...
    case $cfield in
     ...
     FL240EDPARM) ffd=edr240;ipdn=0;ipd1=19;ipd2=30;ipd10=100;ipd11=0;ipd12=39270;icnt=1;;
     FL270EDPARM) ffd=edr270;ipdn=0;ipd1=19;ipd2=30;ipd10=100;ipd11=0;ipd12=34430;icnt=1;;
     FL300EDPARM) ffd=edr300;ipdn=0;ipd1=19;ipd2=30;ipd10=100;ipd11=0;ipd12=30090;icnt=1;;
     FL340EDPARM) ffd=edr340;ipdn=0;ipd1=19;ipd2=30;ipd10=100;ipd11=0;ipd12=25000;icnt=1;;
     FL390EDPARM) ffd=edr390;ipdn=0;ipd1=19;ipd2=30;ipd10=100;ipd11=0;ipd12=19680;icnt=1;;
     FL450EDPARM) ffd=edr450;ipdn=0;ipd1=19;ipd2=30;ipd10=100;ipd11=0;ipd12=14750;icnt=1;;
...
##############################
  ...
  if [ "$IFNAEFS" = "YES" -o  "$IFGEFS" = "YES" ]; then
	...
	ifile_ncep=$COMINNCEP/ge${mem}.t${cyc}z.master.f${nfhrs}.grib2
...
#####################
  ...
  startmsg
  $EXECwafs/wafs_gtg_probability <namin.prob.$nfhrs > $pgmout.${nfhrs}_prob  2> errfile
  export err=$?;err_chk
