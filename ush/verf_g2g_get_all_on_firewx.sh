...
if [ $modnam = namnest ] ; then
 ...
 namnest_orig=/com/nam/prod/nam.${RUN_DAY}
...
hiresw_orig=/com/hiresw/prod/hiresw.${RUN_DAY}
mkdir -p $hiresw
cd $hiresw
if [ $RUN_CYC = '00' ] || [ $RUN_CYC = '12' ] ; then
for hh in 01 02 03 04 05 06 07 08 09 10 11 12 13 14 15 18 24 30 36 ; do
  copygb -g"$firewxgrid" -x $hiresw_orig/conusarw.t${RUN_CYC}z.awp5kmf${hh}.grib2 $hiresw/conusarw.t${RUN_CYC}z.firewx.f${hh}.grib2
  copygb -g"$firewxgrid" -x $hiresw_orig/conusnmmb.t${RUN_CYC}z.awp5kmf${hh}.grib2 $hiresw/conusnmmb.t${RUN_CYC}z.firewx.f${hh}.grib2
done
fi
