!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
       subroutine write_ndfd_grib2(g,npt,nx,ny,nflds,npdt,ncat,nparm,ifcsthr,nlevtype,  &
...
!  input argument list:                                           *
!                                                                 *              
! 1. g(nxy,nflds): floating point array that contains all the   * 
...
!******************************************************************
      ...
      integer(4) npt,nx,ny,nflds,isign,y0,m0,d0,h0,m1,s0,ityped
...
!==> Pack up Grid Definition Section (Section 3) add to GRIB2 message.
       ...
       call apply_template_300_ndfd(nx,ny,igdstmpl,igdstmplen) 
...
!===========================================================================
       subroutine apply_template_300_ndfd(nx,ny,ifield3,len3) 
...
!      integer(4),parameter::lon1=238446000  !east-long of 1st grd pt in micro-deg 
       ...
       integer(4),parameter::lonv=174921000  !y-axis || to long-circle at this long
...
!      integer(4),parameter::ds1=5079000     !grid spacing in x and y
       ...
       ifield3(14) = 48
       ifield3(15) = -90000000
       ifield3(16) = (360.-360./nx)*1000000
       ifield3(17) = (360./nx)*1000000
       ifield3(18) = (160./ny)*1000000
       ifield3(19) = 0
...
!==> ifield4(3):type of generating process (see Code Table 4.3)
       if (trim(typep) == "analysis") then
         ifield4(3) = 0
        elseif (trim(typep) == "forecast") then
         ifield4(3) = 2
        elseif (trim(typep) == "analysis error") then
         ifield4(3) = 7
        else
