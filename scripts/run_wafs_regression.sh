...
#   - Bit-wise identical file
#   - Not bit-wise identical file (check diff reports as below, generated by cmp_grib2_grib2)
#
# (Under working folder, gfs.$PDY/*diff)
# If not bit-wise identical, check diff reports:
