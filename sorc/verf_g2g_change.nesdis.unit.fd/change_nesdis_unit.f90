...
IMPLICIT NONE
!jp INTEGER, PARAMETER :: IMAX=801, JMAX=534
!jp INTEGER, PARAMETER :: MAXDATA=IMAX*JMAX
...
!JP CHARACTER (LEN=120) :: FNAME, FNAME1, OUTFILE, CYCLE
CHARACTER (LEN=120) :: FNAME, FNAME1, OUTFILE
...
CHARACTER (LEN=12):: FHEAD
CHARACTER (LEN=4):: CYCLE
!INTEGER :: VGRID,IMAX,JMAX
INTEGER :: IMAX,JMAX


! added by jphuang go read in grid number
!READ(5,80) FHEAD
!80 FORMAT(A12)
!READ(5,81) CYCLE
!81 FORMAT(A4)
...
DO I=1,JF
  ...
  ELSE
    VAR(I)=DATA(I)
  END IF
  print*,'i,var(i),bmax,bmin=',i,var(i),bmax,bmin
