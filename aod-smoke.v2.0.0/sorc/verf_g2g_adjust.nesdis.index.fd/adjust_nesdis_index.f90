...
REAL(kind=kind_io8), DIMENSION(MAXDATA)  :: VTMP, VC8, VDIAG
...
!ZZ  write(file1,'(a,''A'',i2.2)') trim(xdir),ihr
  ...
  VTMP = 0.
  CALL GETGB(IIN,0,MAXDATA,-1,JPDS,JGDS,NUMOUT,0,KPDS,KGDS,LB,VTMP,IERR)
...
!!
    ...
    VTMP = 0.
    L1=.FALSE.
    CALL GETGB(IIN,0,MAXDATA,-1,JPDS,JGDS,NUMOUT,0,KPDS,KGDS,L1,VTMP,IERR)
!
...
!!
      ...
      VC8  = 0.
      LB=.FALSE.
      CALL GETGB(IIN,0,MAXDATA,-1,JPDS,JGDS,NUMOUT,0,KPDS,KGDS,LB,VC8,IERR)
