...
*    hi = subwrd(rec,3)
    hi = 'noprint'
    if (num=4) ;  hi='0.1' ; endif
    if (num=9) ;  hi='0.2' ; endif
    if (num=14) ;  hi='0.3' ; endif
    if (num=19) ;  hi='0.4' ; endif
    if (num=24) ;  hi='0.5' ; endif
    if (num=29) ;  hi='0.6' ; endif
    if (num=34) ;  hi='0.7' ; endif
    if (num=39) ;  hi='0.8' ; endif
    if (num=44) ;  hi='0.9' ; endif
...
#    if (num<cnum-1)
    if(hi != 'noprint')
      if (vert) 
        'draw string '%(xrs+0.05)%' 'yt' 'hi
      else
        'draw string 'xrs' '%(yb-0.05)%' 'hi
      endif
    endif
    num = num + 1
    if (vert); yb = yt;
